...
public:
    Test1(){
        ...
        fields["test1col2"] = IntegerField("bigint");
        fields["test1col3"] = BinaryField(4, false, true, false);
        fields["test1col4"] = DateTimeField("date", false, "26-06-2004", false);
        fields["test1col5"] = BoolField(false, false, true);
...
public:
    Test2(){
        ...
        fields["test2col7"] = CharField("char",15, true, false);
    }
};
